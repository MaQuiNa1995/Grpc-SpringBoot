...
@GRpcService
public class HelloWorldServerImpl extends HelloWorldServiceImplBase {

	private static final Logger LOGGER = LoggerFactory.getLogger(HelloWorldServerImpl.class);
